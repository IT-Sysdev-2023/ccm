        ...
        <div class="py-5">
                    ...
                    >
                        <template #bodyCell="{ column, record }">
                            <template v-if="column.key === 'action'">
                                ...
                                <a-button
                                    size="small"
                                    v-on:click="openModalDetails(record)"
                                >
                                    <template #icon>
                                        <SettingOutlined />
                                    </template>
            ...
            >
                <div class="mb-4">
                    ...
                    >
                        <a-date-picker
                            @change="onDateChangeReturn"
                            v-model:value="returnDate"
                            style="width: 63%; margin-right: 5px"
                            class="mt-3"
                    /></a-tooltip>
                    <a-button
                        :loading="isLoadingbutton"
                        style="width: 35%; background: #b5fcb2d0"
                        v-on:click="continueToTagg"
                        >Continue tagging?</a-button
                    >
                </div>
            </a-modal>
        </div>
