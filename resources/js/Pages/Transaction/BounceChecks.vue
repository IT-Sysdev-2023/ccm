...
<template>
    ...
    <TreasuryLayout>
                        ...
                        <template #bodyCell="{ column, record, index }">
                            ...
                            <template v-if="column.key === 'action'">
                                ...
                                <a-button
                                    size="small"
                                    class="mx-1"
                                    @click="openUpDetailsFolder(record)"
                                >
                                    <template #icon>
                                        <AuditOutlined />
                                    </template>
        ...
        <a-modal
            v-model:open="openModalReplace"
            title="Replacement Checks Configuration"
            :footer="null"
                ...
                <a-col :span="7">
                    ...
                    <a-card class="mt-1">
                        ...
                        <a-button
                            class="mt-2"
                            block
                            @click="cashButtonType"
                            :class="{ active: isActive === 'cash' }"
                        >
                            <template #icon>
                ...
                <a-col :span="17">
                    <a-card class="flex justify-center" style="height: 100%">
                        <template # v-if="defaultShow">
                            <a-result
                                title="Please select type you wish to replace !"
                        ...
                        <template #extra v-if="cashShow">
                            ...
                            <a-breadcrumb class="mt-2 ml-1">
                                <a-breadcrumb-item
                                    >Cash Amount</a-breadcrumb-item
                                >
                            </a-breadcrumb>

                            <a-input
                                v-model:value="cash_form.rep_cash_amount"
                                class="mb-2"
                                readonly
                                style="width: 550px"
                            ...
                            <a-breadcrumb class="mt-2 ml-1">
                                <a-breadcrumb-item
                                    >Penalty Amount</a-breadcrumb-item
                                >
                            </a-breadcrumb>
                            <a-input
                                v-model:value="cash_form.rep_cash_penalty"
                                class="mb-2"
                            ...
                            >
                                ...
                                <template #suffix>
                                    <a-tooltip
                                        title="Enter penalty amount here!"
                                    >
                                        <InfoCircleOutlined />
                                    </a-tooltip>
                                </template>
                            ...
                            <div
                                v-if="cash_form.errors.rep_cash_penalty"
                                class="text-white"
                                style="
                                    font-size: 12px;
                            ...
                            <a-breadcrumb class="mt-2 ml-1">
                                <a-breadcrumb-item
                                    >AR # & DS #</a-breadcrumb-item
                                >
                            </a-breadcrumb>
                            <a-input
                                v-model:value="cash_form.rep_ar_ds"
                                class="mb-2"
                            ...
                            <div
                                v-if="cash_form.errors.rep_ar_ds"
                                class="text-white"
                                style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                            ...
                            <a-textarea
                                v-model:value="cash_form.rep_reason"
                                placeholder="Your reason of replace"
                                :rows="3"
                            />
                            <div
                                v-if="cash_form.errors.rep_reason"
                                class="text-white"
                                style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                            ...
                            <a-date-picker
                                style="width: 100%"
                                v-model:value="cash_form.rep_date"
                            >
                            </a-date-picker>
                            <div
                                v-if="cash_form.errors.rep_date"
                                class="text-white"
                                style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                        ...
                        <template #extra v-else-if="checkShow">
                            ...
                            <a-row :gutter="[16, 16]">
                                <a-col :span="12" style="width: 600px">
                                    ...
                                    <a-input
                                        class="hidden"
                                        v-model:value="check_form.rep_check_id"
                                    >
                                    </a-input>
                                    <a-input
                                        v-model:value="check_form.accountnumber"
                                    ...
                                    <div
                                        v-if="check_form.errors.accountnumber"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-select
                                        ...
                                        v-model:value="check_form.accountname"
                                        style="width: 100%"
                                        :show-arrow="false"
                                        :filter-option="false"
                                        :not-found-content="
                                    ...
                                    <div
                                        v-if="check_form.errors.accountname"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-input
                                        v-model:value="check_form.checkNumber"
                                    ...
                                    <div
                                        v-if="check_form.errors.checkNumber"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <div
                                        v-if="check_form.errors.rep_check_date"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <div
                                        v-if="check_form.errors.rep_date"
                                ...
                                <a-col :span="12">
                                    ...
                                    <a-select
                                        ...
                                        :default-active-first-option="false"
                                        v-model:value="check_form.checkFrom_id"
                                        style="width: 100%"
                                        :show-arrow="false"
                                        :filter-option="false"
                                        :not-found-content="
                                    ...
                                    <div
                                        v-if="check_form.errors.checkFrom_id"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-select
                                        ...
                                        :default-active-first-option="false"
                                        v-model:value="check_form.bank_id"
                                        style="width: 100%"
                                        :show-arrow="false"
                                        :filter-option="false"
                                        :not-found-content="
                                    ...
                                    <div
                                        v-if="check_form.errors.bank_id"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-select
                                        ...
                                        :default-active-first-option="false"
                                        v-model:value="check_form.customerId"
                                        style="width: 100%"
                                        :show-arrow="false"
                                        :filter-option="false"
                                        :not-found-content="
                                    ...
                                    <div
                                        v-if="check_form.errors.customerId"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-select
                                        ...
                                        v-model:value="check_form.currency_id"
                                        style="width: 100%"
                                    >
                                        <a-select-option
                                    ...
                                    <div
                                        v-if="check_form.errors.currency_id"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-select
                                        ...
                                        v-model:value="check_form.category"
                                        style="width: 100%"
                                    >
                                        <a-select-option
                                    ...
                                    <div
                                        v-if="check_form.errors.category"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-select
                                        ref="select"
                                        placeholder="Select category"
                                        v-model:value="check_form.checkClass"
                                        style="width: 100%"
                                    >
                                        <a-select-option
                                            v-for="(
                                    ...
                                    <div
                                        v-if="check_form.errors.checkClass"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-textarea
                                        v-model:value="check_form.rep_reason"
                                        placeholder="Input text heres"
                                        :rows="4"
                                    />
                                    <div
                                        v-if="check_form.errors.rep_reason"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                        ...
                        <template #extra v-else-if="cashCheckShow">
                            ...
                            <a-row :gutter="[16, 16]">
                                <a-col :span="12" style="width: 600px">
                                    ...
                                    <div
                                        v-if="cash_check_form.errors.rep_ar_ds"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-date-picker
                                        style="width: 100%"
                                        v-model:value="cash_check_form.rep_date"
                                    >
                                    </a-date-picker>
                                    <div
                                        v-if="cash_check_form.errors.rep_date"
                                        class="text-white mb-5"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                ...
                                <a-col :span="12">
                                    ...
                                    <a-select
                                        ...
                                        placeholder="Search bank name"
                                        :default-active-first-option="false"
                                        v-model:value="cash_check_form.bank_id"
                                        style="width: 100%"
                                        :show-arrow="false"
                                        :filter-option="false"
                                        :not-found-content="
                                    ...
                                    <div
                                        v-if="cash_check_form.errors.bank_id"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <div
                                        v-if="cash_check_form.errors.customerId"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <a-select
                                        ref="select"
                                        placeholder="Select category"
                                        v-model:value="cash_check_form.category"
                                        style="width: 100%"
                                    >
                                        <a-select-option
                                            v-for="(catItem, key) in category"
                                    ...
                                    <div
                                        v-if="cash_check_form.errors.category"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    <div
                                        v-if="cash_check_form.errors.checkClass"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                    ...
                                    />
                                    <div
                                        v-if="cash_check_form.errors.rep_reason"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                        ...
                        <template #extra v-if="reDepositShow">
                            ...
                            <a-input
                                v-model:value="re_deposit_form.rep_penalty"
                                class="mb-2"
                                placeholder="Enter penalty amount"
                            >
                                <template #prefix>
                            ...
                            <div
                                v-if="re_deposit_form.errors.rep_penalty"
                                class="text-white"
                                style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                            ...
                            <a-input
                                v-model:value="re_deposit_form.rep_ar_ds"
                                class="mb-2"
                                placeholder="Enter AR# and DS#"
                            >
                                <template #prefix>
                            ...
                            <div
                                v-if="re_deposit_form.errors.rep_ar_ds"
                                class="text-white"
                                style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                            ...
                            <a-textarea
                                v-model:value="re_deposit_form.rep_reason"
                                placeholder="Your reason of replace"
                                :rows="3"
                            />
                            <div
                                v-if="re_deposit_form.errors.rep_reason"
                                class="text-white"
                                style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                            ...
                            <a-date-picker
                                style="width: 100%"
                                v-model:value="re_deposit_form.rep_date"
                            >
                            </a-date-picker>
                            <div
                                v-if="re_deposit_form.errors.rep_date"
                                class="text-white"
                                style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                        ...
                        <template #extra v-else-if="partialPayCash">
                            <div style="width: 500px">
                                ...
                                <a-input
                                    v-model:value="partial_cash_form.rep_ar_ds"
                                    class="mb-2"
                                    placeholder="Enter AR# and DS#"
                                >
                                    <template #prefix>
                                ...
                                <div
                                    v-if="partial_cash_form.errors.rep_ar_ds"
                                    class="text-white"
                                    style="
                                        font-size: 12px;
                                        border: 1px solid #ff5c58;
                                ...
                                <a-textarea
                                    v-model:value="partial_cash_form.rep_reason"
                                    placeholder="Your reason of replace"
                                    :rows="3"
                                />
                                <div
                                    v-if="partial_cash_form.errors.rep_reason"
                                    class="text-white"
                                    style="
                                        font-size: 12px;
                                        border: 1px solid #ff5c58;
                                ...
                                <a-date-picker
                                    style="width: 100%"
                                    v-model:value="partial_cash_form.rep_date"
                                >
                                </a-date-picker>
                                <div
                                    v-if="partial_cash_form.errors.rep_date"
                                    class="text-white"
                                    style="
                                        font-size: 12px;
                                        border: 1px solid #ff5c58;
                        ...
                        <template #extra v-else-if="partialPayCheck">
                            ...
                            <a-row :gutter="[16, 16]">
                                ...
                                <a-col :span="12">
                                    ...
                                    <div
                                        v-if="partial_check_form.errors.bank_id"
                                        class="text-white"
                                        style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
