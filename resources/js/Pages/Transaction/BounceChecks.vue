                ...
                <a-card class="flex justify-center" style="height: 100%">
                    <template # v-if="defaultShow">
                        <a-result title="Please select type you wish to replace !"
                            ...
                            <template #icon>
                                <img src="../../../../public/Logo/ccmpbng.png" alt="ccmrobot" style="height: 160px" />
                            </template>
                            <template #extra> </template>
                        </a-result>
                    </template>
                    <template #extra v-if="cashShow">
                        <p class="text-center font-bold">CASH TYPE</p>
                        <a-breadcrumb class="mt-2 ml-1">
                            <a-breadcrumb-item>Cash Amount</a-breadcrumb-item>
                        </a-breadcrumb>

                        <a-input v-model:value="cash_form.rep_cash_amount" class="mb-2" readonly style="width: 550px"
                        ...
                        <div v-if="cash_form.errors.rep_cash_penalty" class="text-white" style="
                                    font-size: 12px;
                        ...
                        <div v-if="cash_form.errors.rep_ar_ds" class="text-white" style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                                    border-radius: 5px;
                                    background: rgba(255, 99, 71, 0.6);
                        ...
                        <a-textarea v-model:value="cash_form.rep_reason" placeholder="Your reason of replace"
                            :rows="3" />
                        <div v-if="cash_form.errors.rep_reason" class="text-white" style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                                    border-radius: 5px;
                                    background: rgba(255, 99, 71, 0.6);
                        ...
                        <div v-if="cash_form.errors.rep_date" class="text-white" style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                                    border-radius: 5px;
                                    background: rgba(255, 99, 71, 0.6);
                    ...
                    <template #extra v-else-if="checkShow">
                        <p class="text-center font-bold py-5">CHECK TYPE</p>
                        <a-row :gutter="[16, 16]">
                            <a-col :span="12" style="width: 600px">
                                ...
                                <div v-if="check_form.errors.accountnumber" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.accountnumber }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                ...
                                <a-select show-search placeholder="Search acount name"
                                    ...
                                    style="width: 100%" :show-arrow="false" :filter-option="false" :not-found-content="
                                ...
                                <div v-if="check_form.errors.accountname" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.accountname }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                ...
                                <div v-if="check_form.errors.checkNumber" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.checkNumber }}
                                </div>
                                ...
                                <a-date-picker v-model:value="
                                            check_form.rep_check_date
                                        " style="width: 100%">
                                </a-date-picker>
                                <div v-if="check_form.errors.rep_check_date" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.rep_check_date }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                    <a-breadcrumb-item>Check Received</a-breadcrumb-item>
                                </a-breadcrumb>
                                <a-date-picker v-model:value="
                                            check_form.rep_check_received
                                        " style="width: 100%">
                                </a-date-picker>
                                <div v-if="
                                            check_form.errors.rep_check_received
                                ...
                                <div v-if="
                                            check_form.errors.rep_check_penalty
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <a-breadcrumb class="mt-2 ml-1">
                                    <a-breadcrumb-item>Approving
                                        Officer</a-breadcrumb-item>
                                </a-breadcrumb>
                                <a-select show-search placeholder="Search approving officer"
                                    :default-active-first-option="false" v-model:value="
                                            check_form.approvingOfficer
                                ...
                                <div v-if="
                                            check_form.errors.approvingOfficer
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <div v-if="check_form.errors.rep_date" class="text-white mb-5" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.rep_date }}
                                </div>
                            </a-col>
                            <a-col :span="12">
                                <a-breadcrumb class="mt-2 ml-1">
                                ...
                                <div v-if="check_form.errors.checkFrom_id" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.checkFrom_id }}
                                </div>
                                ...
                                <div v-if="check_form.errors.bank_id" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.bank_id }}
                                </div>
                                ...
                                <div v-if="check_form.errors.customerId" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                ...
                                <div v-if="check_form.errors.currency_id" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.currency_id }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                    <a-breadcrumb-item>Check Category</a-breadcrumb-item>
                                </a-breadcrumb>
                                <a-select ref="select" placeholder="Select category" v-model:value="check_form.category"
                                    style="width: 100%">
                                    <a-select-option v-for="(catItem, key) in category" v-model:value="
                                                catItem.check_category
                                            ">{{
                                        catItem.check_category
                                        }}</a-select-option>
                                </a-select>
                                <div v-if="check_form.errors.category" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.category }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                ...
                                <a-select ref="select" placeholder="Select category"
                                    ...
                                    <a-select-option v-for="(
                                                chclass, key
                                            ) in check_class" v-model:value="chclass.check_class">{{
                                        chclass.check_class
                                        }}</a-select-option>
                                </a-select>
                                <div v-if="check_form.errors.checkClass" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.checkClass }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                    <a-breadcrumb-item>Reason for
                                        return</a-breadcrumb-item>
                                </a-breadcrumb>
                                <a-textarea v-model:value="check_form.rep_reason" placeholder="Input text heres"
                                    :rows="4" />
                                <div v-if="check_form.errors.rep_reason" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ check_form.errors.rep_reason }}
                                </div>
                    ...
                    <template #extra v-else-if="cashCheckShow">
                        <p class="text-center font-bold py-5">
                            CHECK AND CASH TYPE
                        </p>
                        ...
                        <a-row :gutter="[16, 16]">
                            <a-col :span="12" style="width: 600px">
                                ...
                                <a-input class="hidden" v-model:value="
                                            cash_check_form.rep_check_id
                                        ">
                                </a-input>
                                <a-input v-model:value="
                                            cash_check_form.accountnumber
                                ...
                                <div v-if="
                                            cash_check_form.errors.accountnumber
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <div v-if="
                                            cash_check_form.errors.accountname
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <div v-if="
                                            cash_check_form.errors.checkNumber
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <a-date-picker v-model:value="
                                            cash_check_form.rep_check_date
                                        " style="width: 100%">
                                </a-date-picker>
                                <div v-if="
                                            cash_check_form.errors
                                                .rep_check_date
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                ...
                                <a-date-picker v-model:value="
                                            cash_check_form.rep_check_received
                                        " style="width: 100%">
                                </a-date-picker>
                                <div v-if="
                                            cash_check_form.errors
                                ...
                                <a-input v-model:value="
                                            cash_check_form.rep_check_amount
                                        " placeholder="Basic usage" readonly style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                                ...
                                <a-input v-model:value="
                                            cash_check_form.rep_cash_amount
                                        " placeholder="cash amount" style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                                    <template #suffix>
                                ...
                                <a-input v-model:value="
                                            cash_check_form.rep_ar_ds
                                        " placeholder="ar and ds" style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                                    <template #suffix>
                                ...
                                <div v-if="cash_check_form.errors.rep_ar_ds" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ cash_check_form.errors.rep_ar_ds }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                    <a-breadcrumb-item>Penalty</a-breadcrumb-item>
                                </a-breadcrumb>
                                <a-input v-model:value="
                                            cash_check_form.rep_check_penalty
                                        " placeholder="Enter Penalty Amount" style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                                ...
                                <a-select show-search placeholder="Search approving officer"
                                    :default-active-first-option="false" v-model:value="
                                            cash_check_form.approvingOfficer
                                        " style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="
                                            isRetrieving ? undefined : null
                                        " :options="appoffOption" @search="handleSearchEmployee">
                                ...
                                <div v-if="cash_check_form.errors.rep_date" class="text-white mb-5" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ cash_check_form.errors.rep_date }}
                                </div>
                            </a-col>
                            <a-col :span="12">
                                <a-breadcrumb class="mt-2 ml-1">
                                ...
                                <div v-if="
                                            cash_check_form.errors.checkFrom_id
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <div v-if="cash_check_form.errors.bank_id" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ cash_check_form.errors.bank_id }}
                                </div>
                                ...
                                <div v-if="cash_check_form.errors.customerId" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                ...
                                <a-select placeholder="Select Currency" v-model:value="
                                            cash_check_form.currency_id
                                        " style="width: 100%">
                                    <a-select-option v-for="(item, key) in currency" v-model:value="item.currency_id">{{
                                        item.currency_name
                                        }}</a-select-option>
                                ...
                                <div v-if="
                                            cash_check_form.errors.currency_id
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <div v-if="cash_check_form.errors.category" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ cash_check_form.errors.category }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                    <a-breadcrumb-item>Check class</a-breadcrumb-item>
                                </a-breadcrumb>
                                <a-select ref="select" placeholder="Select category" v-model:value="
                                            cash_check_form.checkClass
                                        " style="width: 100%">
                                    <a-select-option v-for="(
                                                chclass, key
                                            ) in check_class" v-model:value="chclass.check_class">{{
                                ...
                                <div v-if="cash_check_form.errors.checkClass" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ cash_check_form.errors.checkClass }}
                                </div>
                                <a-breadcrumb class="mt-2 ml-1">
                                    <a-breadcrumb-item>Reason for
                                        return</a-breadcrumb-item>
                                ...
                                <a-textarea v-model:value="
                                            cash_check_form.rep_reason
                                        " placeholder="Input text heres" :rows="4" />
                                <div v-if="cash_check_form.errors.rep_reason" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ cash_check_form.errors.rep_reason }}
                                </div>
                                ...
                                <a-row :gutter="[16, 16]" class="mt-4">
                                    ...
                                    <a-col :span="12" class="mb-7">
                                        <a-button block class="mt-2" type="primary" @click="
                    ...
                    <template #extra v-if="reDepositShow">
                        ...
                        <div v-if="re_deposit_form.errors.rep_penalty" class="text-white" style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                                    border-radius: 5px;
                                    background: rgba(255, 99, 71, 0.6);
                        ...
                        <div v-if="re_deposit_form.errors.rep_ar_ds" class="text-white" style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                                    border-radius: 5px;
                                    background: rgba(255, 99, 71, 0.6);
                        ...
                        <a-textarea v-model:value="re_deposit_form.rep_reason" placeholder="Your reason of replace"
                            :rows="3" />
                        <div v-if="re_deposit_form.errors.rep_reason" class="text-white" style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                                    border-radius: 5px;
                                    background: rgba(255, 99, 71, 0.6);
                        ...
                        <div v-if="re_deposit_form.errors.rep_date" class="text-white" style="
                                    font-size: 12px;
                                    border: 1px solid #ff5c58;
                                    border-radius: 5px;
                                    background: rgba(255, 99, 71, 0.6);
                    ...
                    <template #extra v-else-if="partialPayCash">
                        <div style="width: 500px">
                            <p class="text-center font-bold">
                                PARTIAL PAYMENTS CASH TYPE
                            </p>
                            <a-breadcrumb class="mt-2 ml-1">
                                <a-breadcrumb-item>Cash Amount</a-breadcrumb-item>
                            </a-breadcrumb>
                            <a-input v-model:value="
                                        partial_cash_form.rep_check_id
                                    " class="hidden">
                            </a-input>
                            <a-input v-model:value="
                                        partial_cash_form.rep_cash_amount
                                    " class="mb-2" readonly placeholder="Enter cash amount">
                                <template #prefix>
                                    <MoneyCollectOutlined />
                                </template>
                                <template #suffix>
                            ...
                            <a-input v-model:value="
                                        partial_cash_form.rep_cash_penalty
                                    " class="mb-2" placeholder="Enter penalty amount">
                                <template #prefix>
                                    <MoneyCollectOutlined />
                                </template>
                                <template #suffix>
                            ...
                            <div v-if="partial_cash_form.errors.rep_ar_ds" class="text-white" style="
                                        font-size: 12px;
                                        border: 1px solid #ff5c58;
                                        border-radius: 5px;
                                        background: rgba(255, 99, 71, 0.6);
                            ...
                            <div v-if="partial_cash_form.errors.rep_reason" class="text-white" style="
                                        font-size: 12px;
                                        border: 1px solid #ff5c58;
                                        border-radius: 5px;
                                        background: rgba(255, 99, 71, 0.6);
                            ...
                            <div v-if="partial_cash_form.errors.rep_date" class="text-white" style="
                                        font-size: 12px;
                                        border: 1px solid #ff5c58;
                                        border-radius: 5px;
                                        background: rgba(255, 99, 71, 0.6);
                            ...
                            <a-row :gutter="[16, 16]">
                                ...
                                <a-col :span="12">
                                    <a-button block type="primary" @click="
                    ...
                    <template #extra v-else-if="partialPayCheck">
                        ...
                        <a-row :gutter="[16, 16]">
                            <a-col :span="12" style="width: 600px">
                                ...
                                <a-input class="hidden" v-model:value="
                                            partial_check_form.rep_check_id
                                        ">
                                </a-input>
                                <a-input v-model:value="
                                            partial_check_form.accountnumber
                                        " placeholder="Enter Account Number" style="width: 100%">
                                    <template #prefix>
                                        <NumberOutlined />
                                    </template>
                                ...
                                <a-select show-search placeholder="Search acount name"
                                    :default-active-first-option="false" v-model:value="
                                            partial_check_form.accountname
                                        " style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="
                                            isRetrieving ? undefined : null
                                        " :options="accountOption" @search="handleSearchAccountName">
                                ...
                                <a-input v-model:value="
                                            partial_check_form.checkNumber
                                        " placeholder="Enter Check number" style="width: 100%">
                                    <template #prefix>
                                        <NumberOutlined />
                                    </template>
                                ...
                                <a-date-picker v-model:value="
                                            partial_check_form.rep_check_date
                                        " style="width: 100%">
                                </a-date-picker>
                                <div v-if="
                                            partial_check_form.errors
                                ...
                                <a-date-picker v-model:value="
                                            partial_check_form.rep_check_received
                                        " style="width: 100%">
                                </a-date-picker>
                                <div v-if="
                                            partial_check_form.errors
                                ...
                                <a-input v-model:value="
                                            partial_check_form.rep_check_amount
                                        " placeholder="Basic usage" readonly style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                                ...
                                <a-input v-model:value="
                                            partial_check_form.rep_check_penalty
                                        " placeholder="Enter Penalty Amount" style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                                ...
                                <a-select show-search placeholder="Search approving officer"
                                    :default-active-first-option="false" v-model:value="
                                            partial_check_form.approvingOfficer
                                        " style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="
                                            isRetrieving ? undefined : null
                                        " :options="appoffOption" @search="handleSearchEmployee">
                                ...
                                <a-date-picker style="width: 100%" v-model:value="
                                            partial_check_form.rep_date
                                        ">
                                </a-date-picker>
                                <div v-if="
                                            partial_check_form.errors.rep_date
                                        " class="text-white mb-5" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                            ...
                            <a-col :span="12">
                                ...
                                <a-select show-search placeholder="Search check from"
                                    :default-active-first-option="false" v-model:value="
                                            partial_check_form.checkFrom_id
                                        " style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="
                                            isRetrieving ? undefined : null
                                        " :options="checkOption" @search="handleSearchCheckFrom">
                                ...
                                <div v-if="partial_check_form.errors.bank_id" class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                            background: rgba(255, 99, 71, 0.6);
                                        ">
                                    {{ partial_check_form.errors.bank_id }}
                                </div>
                                ...
                                <a-select placeholder="Select Currency" v-model:value="
                                            partial_check_form.currency_id
                                        " style="width: 100%">
                                    <a-select-option v-for="(item, key) in currency" v-model:value="item.currency_id">{{
                                        item.currency_name
                                        }}</a-select-option>
                                ...
                                <div v-if="
                                            partial_check_form.errors.category
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <div v-if="
                                            partial_check_form.errors.checkClass
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
                                ...
                                <a-textarea v-model:value="
                                            partial_check_form.rep_reason
                                        " placeholder="Input text heres" :rows="4" />
                                <div v-if="
                                            partial_check_form.errors.rep_reason
                                        " class="text-white" style="
                                            font-size: 12px;
                                            border: 1px solid #ff5c58;
                                            border-radius: 5px;
