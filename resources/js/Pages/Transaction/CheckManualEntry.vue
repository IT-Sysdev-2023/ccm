<template>
    <Head title="Manual Check Entry" />
        ...
        <a-modal
            ...
            title="Add manual checks Modal"
            :footer="null"
            width="90%"
            style="top: 50px"
            :after-close="() => manual_check_form.clearErrors()"
            ...
            <a-card>
                <a-row :gutter="[16, 16]">
                    <a-col :span="8">
                        ...
                        <a-input
                            v-model:value="manual_check_form.accountnumber"
                        ...
                        <div
                            v-if="manual_check_form.errors.accountnumber"
                        ...
                        <a-date-picker
                            v-model:value="manual_check_form.checkdate"
                            style="width: 100%"
                        >
                        </a-date-picker>
                        <div
                            v-if="manual_check_form.errors.checkdate"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-select
                            ...
                            v-model:value="manual_check_form.currency"
                            style="width: 100%"
                        >
                            <a-select-option
                                v-for="(item, key) in currency"
                                v-model:value="item.currency_id"
                                >{{ item.currency_name }}</a-select-option
                            >
                        </a-select>
                        <div
                            v-if="manual_check_form.errors.currency"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-select
                            ...
                            v-model:value="manual_check_form.checkfrom"
                            style="width: 100%"
                            :show-arrow="false"
                            :filter-option="false"
                        ...
                        <div
                            v-if="manual_check_form.errors.checkfrom"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-select
                            ...
                            :default-active-first-option="false"
                            v-model:value="manual_check_form.accountname"
                            style="width: 100%"
                            :show-arrow="false"
                            :filter-option="false"
                            :not-found-content="isRetrieving ? undefined : null"
                        ...
                        <div
                            v-if="manual_check_form.errors.accountname"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                    ...
                    <a-col :span="8">
                        ...
                        <a-select
                            ...
                            :default-active-first-option="false"
                            v-model:value="manual_check_form.customer"
                            style="width: 100%"
                            :show-arrow="false"
                            :filter-option="false"
                            :not-found-content="isRetrieving ? undefined : null"
                        ...
                        <div
                            v-if="manual_check_form.errors.customer"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-input
                            v-model:value="manual_check_form.checkamount"
                            placeholder="Enter here..."
                        >
                            <template #prefix> </template>
                        ...
                        <div
                            v-if="manual_check_form.errors.checkamount"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-select
                            placeholder="Select Currency"
                            v-model:value="manual_check_form.checkclass"
                            style="width: 100%"
                        >
                            <a-select-option
                                v-for="(item, key) in check_class"
                                v-model:value="item.check_class"
                                >{{ item.check_class }}</a-select-option
                            >
                        </a-select>
                        <div
                            v-if="manual_check_form.errors.checkclass"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-input
                            v-model:value="manual_check_form.checknumber"
                            placeholder="Enter here..."
                        >
                            <template #prefix> </template>
                        ...
                        <div
                            v-if="manual_check_form.errors.checknumber"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-select
                            ...
                            :default-active-first-option="false"
                            v-model:value="manual_check_form.bankname"
                            style="width: 100%"
                            :show-arrow="false"
                            :filter-option="false"
                            :not-found-content="isRetrieving ? undefined : null"
                        ...
                        <div
                            v-if="manual_check_form.errors.bankname"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                    ...
                    <a-col :span="8">
                        ...
                        <a-date-picker
                            v-model:value="manual_check_form.checkreceived"
                            style="width: 100%"
                        >
                        </a-date-picker>
                        <div
                            v-if="manual_check_form.errors.checkreceived"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-select
                            placeholder="Select Currency"
                            v-model:value="manual_check_form.checkcategory"
                            style="width: 100%"
                        >
                            <a-select-option
                                v-for="(item, key) in category"
                                v-model:value="item.check_category"
                                >{{ item.check_category }}</a-select-option
                            >
                        </a-select>
                        <div
                            v-if="manual_check_form.errors.checkcategory"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
                        ...
                        <a-select
                            ...
                            placeholder="Search bank name"
                            :default-active-first-option="false"
                            v-model:value="manual_check_form.approvingOfficer"
                            style="width: 100%"
                            :show-arrow="false"
                            :filter-option="false"
                            :not-found-content="isRetrieving ? undefined : null"
                        ...
                        <div
                            v-if="manual_check_form.errors.approvingOfficer"
                            class="text-white mb-3"
                            style="
                                font-size: 12px;
                                border: 1px solid #ff5c58;
