                ...
                <a-card class="flex justify-center" style="height: 100%; ">
                    ...
                    <template #extra v-else-if="checkShow">
                        ...
                        <a-row :gutter="[16, 16]">
                            <a-col :span="12" style="width: 600px">
                                ...
                                <a-input v-model:value="check_form.rep_check_amount" placeholder="Basic usage" readonly
                                    style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                                ...
                                <a-input v-model:value="check_form.rep_check_penalty" placeholder="Enter Penalty Amount"
                                    style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                            ...
                            <a-col :span="12">
                                ...
                                <div v-if="check_form.errors.customerId" class="text-red-600" style="font-size: 12px;">
                                    {{
                                ...
                                <div v-if="check_form.errors.currency_id" class="text-red-600" style="font-size: 12px;">
                                    {{
                                ...
                                <div v-if="check_form.errors.category" class="text-red-600" style="font-size: 12px;">
                                    {{
                                ...
                                <div v-if="check_form.errors.checkClass" class="text-red-600" style="font-size: 12px;">
                                    {{
                                ...
                                <a-textarea v-model:value="check_form.rep_reason" placeholder="Input text heres"
                                    :rows="4" />
                                <div v-if="check_form.errors.rep_reason" class="text-red-600" style="font-size: 12px;">
                                    {{
                    ...
                    <template #extra v-else-if="cashCheckShow">
                        ...
                        <a-row :gutter="[16, 16]">
                            <a-col :span="12" style="width: 600px">
                                ...
                                <a-input v-model:value="cash_check_form.checkNumber" placeholder="Enter Check number"
                                    style="width: 100%">
                                    <template #prefix>
                                        <NumberOutlined />
                                    </template>
                                ...
                                <a-date-picker v-model:value="cash_check_form.rep_check_received" style="width: 100%">
                                </a-date-picker>
                            ...
                            <a-col :span="12">
                                ...
                                <a-select show-search placeholder="Search check from"
                                    :default-active-first-option="false" v-model:value="cash_check_form.checkFrom_id"
                                    style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="isRetrieving ? undefined : null" :options="checkOption"
                                    @search="handleSearchCheckFrom">
                                    <template v-if="isRetrieving" #notFoundContent>
                                ...
                                <a-textarea v-model:value="cash_check_form.rep_reason" placeholder="Input text heres"
                                    :rows="4" />
                                ...
                                <a-row :gutter="[16, 16]" class="mt-4">
                                    ...
                                    <a-col :span="12" class="mb-7">
                                        <a-button block class="mt-2" type="primary" @click="submitReplacementCashCheck"
                    ...
                    <template #extra v-else-if="partialPayCash">
                        <div style="width: 500px">
                            ...
                            <div v-if="partial_cash_form.errors.rep_date" class="text-red-600" style="font-size: 12px;">
                                {{
                            ...
                            <a-row :gutter="[16, 16]">
                                ...
                                <a-col :span="12">
                                    <a-button block type="primary" @click="submitReplacementCashPartial" class="mt-5"
                                        :loading="partial_cash_form.processing">
                                        <template #icon>
                                            <SaveOutlined />
                                        </template>
                    ...
                    <template #extra v-else-if="partialPayCheck">
                        ...
                        <a-row :gutter="[16, 16]">
                            <a-col :span="12" style="width: 600px">
                                ...
                                <a-select show-search placeholder="Search acount name"
                                    :default-active-first-option="false" v-model:value="partial_check_form.accountname"
                                    style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="isRetrieving ? undefined : null" :options="accountOption"
                                    @search="handleSearchAccountName">
                                    <template v-if="isRetrieving" #notFoundContent>
                                ...
                                <a-input v-model:value="partial_check_form.checkNumber" placeholder="Enter Check number"
                                    style="width: 100%">
                                    <template #prefix>
                                        <NumberOutlined />
                                    </template>
                                ...
                                <a-date-picker v-model:value="partial_check_form.rep_check_date" style="width: 100%">
                                </a-date-picker>
                                ...
                                <a-input v-model:value="partial_check_form.rep_check_amount" placeholder="Basic usage"
                                    readonly style="width: 100%">
                                    <template #prefix>
                                        <MoneyCollectOutlined />
                                    </template>
                            ...
                            <a-col :span="12">
                                ...
                                <a-select show-search placeholder="Search check from"
                                    :default-active-first-option="false" v-model:value="partial_check_form.checkFrom_id"
                                    style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="isRetrieving ? undefined : null" :options="checkOption"
                                    @search="handleSearchCheckFrom">
                                    <template v-if="isRetrieving" #notFoundContent>
                                ...
                                <a-select show-search placeholder="Search customer name"
                                    :default-active-first-option="false" v-model:value="partial_check_form.customerId"
                                    style="width: 100%" :show-arrow="false" :filter-option="false"
                                    :not-found-content="isRetrieving ? undefined : null" :options="customerOption"
                                    @search="handleSearchCustomer">
                                    <template v-if="isRetrieving" #notFoundContent>
                                ...
                                <a-select placeholder="Select Currency" v-model:value="partial_check_form.currency_id"
                                    style="width: 100%">
                                ...
                                <a-textarea v-model:value="partial_check_form.rep_reason" placeholder="Input text heres"
                                    :rows="4" />
