...
<div style="width: 98%; margin: 0 auto;">
        ...
        <div class="flex justify-center">
            ...
            <a-card style="width: 40%;" class="mb-10">
                <p class="text-center">Programmers</p>
                <a-row :gutter="[16, 16]">
                    <a-col :span="12">
                        <div class="card">
                            <button class="mail">
                                <svg class="lucide lucide-mail" stroke-linejoin="round" stroke-linecap="round"
                            ...
                            <div class="profile-pic">
                                <img style="z-index: 99;" src="/storage/users-image/" alt="img">
                            </div>
                            <div class="bottom">
                                <div class="content">
                    ...
                    <!-- <a-col :span="12">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum, odio dolore, modi
                            consectetur animi facere magnam, dignissimos ab obcaecati temporibus ratione culpa?
                            Asperiores quisquam reiciendis natus minus numquam illo ullam.
                        </a-col>
                        <a-col :span="12">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum, odio dolore, modi
                            consectetur animi facere magnam, dignissimos ab obcaecati temporibus ratione culpa?
                    ...
                    <a-row :gutter="[16, 16]">
                        <a-col :span="8">
                            <div class="card">
                                ...
                                <div class="profile-pic">
                                    <img style="z-index: 99;" src="/storage/users-image/79" alt="img">
                                </div>
                                <div class="bottom">
                                    <div class="content">
                                        <span class="name">My Name</span>
                        ...
                        <a-col :span="8">
                            <div class="card">
                                ...
                                <div class="profile-pic">
                                    <img style="z-index: 99;" src="/storage/users-image/78" alt="img">
                                </div>
                                <div class="bottom">
                                    <div class="content">
                                        <span class="name">My Name</span>
                        ...
                        <a-col :span="8">
                            <div class="card">
                                ...
                                <div class="profile-pic">
                                    <img style="z-index: 99;" src="/storage/users-image/15" alt="img">
                                </div>
                                <div class="bottom">
                                    <div class="content">
                                        <span class="name">My Name</span>
                    ...
                    <a-row :gutter="[16, 16]">
                        <a-col :span="8">
                            <div class="card">
                                ...
                                <div class="profile-pic">
                                    <img style="z-index: 99;" src="/storage/users-image/67" alt="img">
                                </div>
                                <div class="bottom">
                                    <div class="content">
                                        <span class="name">My Name</span>
