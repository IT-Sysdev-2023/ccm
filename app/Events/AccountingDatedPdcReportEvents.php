...
class AccountingDatedPdcReportEvents implements ShouldBroadcastNow
{
    ...
    {
        return [
            new PrivateChannel('generating-dated-pdc-reports-accounting.' . $this->user->id),
        ];
    }

    public function broadcastAs()
    {
        return 'generating-pdc-reports';
    }
